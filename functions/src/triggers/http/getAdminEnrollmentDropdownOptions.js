...
exports.getAdminEnrollmentDropdownOptions = onRequest(
  {
  ...
  async (req, res) => {
    ...
    try {
      ...
      const [
        ...
        db.query(sectionQuery, sectionParams),
        db.query('SELECT DISTINCT acad_term FROM "Enrollment" ORDER BY acad_term'),
